...
namespace WebApplication1.Controllers
{
    public class YorumController : Controller
    {
        ...
        // POST: Yorum/Delete/5  //silmek istediğinden emin misin kısmı
        ...
        protected override void Dispose(bool disposing) //Kaynakların her zaman uygun şekilde temizlendiğinden emin olmak için
        {
            if (disposing)
            {
                db.Dispose();
